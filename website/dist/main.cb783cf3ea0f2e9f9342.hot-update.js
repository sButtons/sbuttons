...
function Header({
  ...
  function toggleSidebar() {
    if (menu) {
      let add = 'animate__slideInLeft',
          remove = 'animate__slideOutLeft';

      if (menu.classList.contains('animate__slideInLeft')) {
        add = 'animate__slideOutLeft';
        remove = 'animate__slideInLeft';
      }
  ...
  function closeSidebar(e) {
    console.log(e.target, menuToggleRef.current, !e.target.isSameNode(menuToggleRef.current), !menuToggleRef.current.contains(e.target), !menu.contains(e.target));

    if (e.target.id !== 'sidebar' && !e.target.isSameNode(menuToggleRef.current) && !menuToggleRef.current.contains(e.target) && !menu.contains(e.target) && menu.classList.contains('animate__slideInLeft')) {
      changeSidebarClassesCallback('animate__slideOutLeft', 'animate__slideInLeft');
    }
  }

  const closeSidebarCallback = Object(react__WEBPACK_IMPORTED_MODULE_0__["useCallback"])(closeSidebar, [changeSidebarClassesCallback, menu]);
  const toggleSidebarCallback = Object(react__WEBPACK_IMPORTED_MODULE_0__["useCallback"])(toggleSidebar, [changeSidebarClassesCallback, menu]);
  const resizeListener = Object(react__WEBPACK_IMPORTED_MODULE_0__["useCallback"])(() => {
    if (window.innerWidth < 768 && previousWidth >= 768 && !menu.classList.contains('animate__slideInLeft')) {
      toggleSidebarCallback();
    } else {
      setPreviousWidth(window.innerWidth);
    }
  }, [menu, previousWidth, toggleSidebarCallback]);
...
_s(Header, "wC1m4csTlMqrS44XQYx3y/E9uHo=", false, function () {
...
//# sourceMappingURL=main.cb783cf3ea0f2e9f9342.hot-update.js.map