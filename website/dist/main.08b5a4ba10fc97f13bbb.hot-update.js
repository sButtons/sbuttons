...
function MenuToggler() {
  ...
  const clickOutsideSidebarCallback = Object(react__WEBPACK_IMPORTED_MODULE_0__["useCallback"])(e => {
    if (e.target && menuToggleRef && menuToggleRef.current && e.target.id !== 'sidebar' && !e.target.isSameNode(menuToggleRef.current) && !menuToggleRef.current.contains(e.target) && !menu.contains(e.target) && menu.classList.contains(openClasses)) {
...
//# sourceMappingURL=main.08b5a4ba10fc97f13bbb.hot-update.js.map