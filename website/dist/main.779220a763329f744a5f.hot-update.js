...
function useDarkMode({
  ...
  const toggleDarkMode = function (on = true) {
    setDarkMode(on);
    localStorage.setItem('theme', on ? darkModeClass : lightModeClass);
  };
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(() => {
    ...
    setDarkMode(theme === darkModeClass);
  }, [darkModeClass, element, lightModeClass]);
  return [isDarkMode, toggleDarkMode];
}

_s(useDarkMode, "R12R9TRCqsrElilZ4oJDMFKMyJY=");
...
//# sourceMappingURL=main.779220a763329f744a5f.hot-update.js.map