...
function MenuToggler() {
  ...
  function closeSidebar(e) {
    if (e.target && e.target.id !== 'sidebar' && !e.target.isSameNode(menuToggleRef.current) && !menuToggleRef.current.contains(e.target) && !menu.contains(e.target) && menu.classList.contains(openClasses)) {
...
//# sourceMappingURL=main.3179237b3b21846f37a4.hot-update.js.map