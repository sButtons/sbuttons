...
function Header({
  ...
  function closeSidebar(e) {
    console.log(e.target.id !== 'sidebar', !menu.contains(e.target), menu.classList.contains('animate__slideInLeft'));

    if (e.target.id !== 'sidebar' && !menu.contains(e.target) && menu.classList.contains('animate__slideInLeft')) {
...
//# sourceMappingURL=main.b774bcdd69bcd9e0e66f.hot-update.js.map