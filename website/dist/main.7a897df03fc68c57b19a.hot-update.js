...
function Header({
  ...
  function closeSidebar(e) {
    const classesStr = "." + e.target.classList.toString().replaceAll(" ", " .");
    console.log(classesStr, e.target.id !== 'sidebar', document.querySelector('#sidebar ' + classesStr), menu.classList.contains('animate__slideInLeft'));

    if (e.target.id !== 'sidebar' && !document.querySelector('#sidebar ' + classesStr) && menu.classList.contains('animate__slideInLeft')) {
...
_s(Header, "IkTLvgn3HTWfQwHWIM725bokc/4=", false, function () {
...
//# sourceMappingURL=main.7a897df03fc68c57b19a.hot-update.js.map