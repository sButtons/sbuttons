...
function Header({
  ...
  function closeSidebar(e) {
    if (e.target.id !== 'sidebar' && !e.target.isSameNode(menuToggleRef.current) && !menu.contains(e.target) && menu.classList.contains('animate__slideInLeft')) {
...
//# sourceMappingURL=main.1ba12624cb7d9d4b5385.hot-update.js.map