      ...
      if (buttonType.type === type) {
        button = {
          ...
          type: {
            ...
            shouldHaveRoundedType: buttonType.hasOwnAttribute('shouldHaveRoundedType') ? buttonType.shouldHaveRoundedType : true,
            shouldHaveBlockType: buttonType.hasOwnAttribute('shouldHaveBlockType') ? buttonType.shouldHaveBlockType : true,
        ...
        return buttonType.children.some(buttonChild => {
          if (buttonChild.type === type) {
            button = {
              ...
              type: {
                name: buttonType.label,
                shouldHaveRoundedType: buttonChild.hasOwnAttribute('shouldHaveRoundedType') ? buttonChild.shouldHaveRoundedType : true,
                shouldHaveBlockType: buttonChild.hasOwnAttribute('shouldHaveBlockType') ? buttonChild.shouldHaveBlockType : true,
...
//# sourceMappingURL=main.12d57c6d762b20a4cfca.hot-update.js.map