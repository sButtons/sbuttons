$(document).ready(function () {
  ...
  * @property {string} [text] - denotes the text to be shown on the button, if omitted shows default text
  ...
  * @property {boolean} shouldHaveRoundedType - indicates if rounded button type should hidden or not
  * @property {boolean} shouldHaveBlockType - indicates if block button type should hidden or not
   */
  var buttons = [
    {
      type: "basic",
